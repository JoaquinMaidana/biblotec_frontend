  ...
  <div class="collapse" id="collapseScanner">
    <div class="controls">
      ...
      <!--<fieldset class="reader-config-group">-->
        ...
        <div class="row mt-3">
          <div class="col-3 text-end">
            <label>Tamaño del parche:</label>
          </div>
          <div class="col">
            <select name="locator_patch-size" class="form-control">
              <option value="x-small">Muy chico</option>
              <option value="small">Chico</option>
              <option selected="selected" value="medium">Mediano</option>
        ...
        <div class="row mt-3">
          <div class="col-3 text-end">
            <label>Media muestra:</label>
          </div>
          <div class="col">
            <input type="checkbox" checked="checked" name="locator_half-sample" class="form-check-input" />
          </div>
        </div>
