        ...
        $(document).ready(function() {
            ...
            $('#tablaCategorias').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: function(data) {
                            return "<span onclick='editarCategoria(" + data.cat_id + ",`" + data.cat_nombre + "`)'><i class='fa-solid fa-pencil'></i></span><span onclick='desactivarCategoria(" + data.cat_id + ",`" + data.cat_nombre + "`)'><i class='fa-solid fa-x'></i></span>";
                        }
                    },
                ],
            });
