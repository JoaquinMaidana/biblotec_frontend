        ...
        <table id="todas" class="display compact">
            ...
            <tbody> 
                ...
                foreach($favoritos as $fav){
                    ...
                    if ($fav->fav_usu_id == Yii::$app->user->identity->id && $fav->fav_estado > 0){ //si el id de usuario de favoritos es igual al id del usuario logueado
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?= Html::a('Ver mas', ['view', 'idlibro'=> $libro->id], ['class' => 'btn btn-success']) ?> 
                                ...
                                <?= Html::beginForm(['favoritos/update'], 'post') ?>
                                    ...
                                    <div id="modalQuitarFavorito<?= $libro->id?>" class="modal" tabindex="-1">
                                        <div class="modal-dialog">
                                            ...
                                            <input type="hidden" name="idusu" value="<?= $fav->fav_usu_id ?>" ></input>
                                            <input type="hidden" name="estado" value="<?= $fav->fav_estado ?>"></input>
                                            <input type="hidden" name="idfav" value="<?= $fav->id ?>"></input>
